...
struct akcipher_alg {
	...
	int (*set_priv_key)(struct crypto_akcipher *tfm, const void *key,
			    unsigned int keylen);
	int (*set_key_noasn1)(struct crypto_akcipher *tfm, const void *key,
			    unsigned int keylen);
	int (*set_key_noasn1_rawu64bytes)(struct crypto_akcipher *tfm, const void *key,
			    unsigned int keylen);
...
static inline int crypto_akcipher_set_key_noasn1(struct crypto_akcipher *tfm,
					       const void *key,
					       unsigned int keylen)
{
	struct akcipher_alg *alg = crypto_akcipher_alg(tfm);

	return alg->set_key_noasn1(tfm, key, keylen);
}

static inline int crypto_akcipher_set_key_noasn1_rawu64bytes(struct crypto_akcipher *tfm,
					       const void *key,
					       unsigned int keylen)
{
	struct akcipher_alg *alg = crypto_akcipher_alg(tfm);

	return alg->set_key_noasn1_rawu64bytes(tfm, key, keylen);
}
